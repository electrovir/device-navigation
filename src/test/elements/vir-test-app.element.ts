...
import {createNavSelector, nav} from '../../directives/nav.directive';
    ...
    renderCallback({host, state, updateState}) {
        ...
        return html`
            ...
            <ul>
                ...
                <li>Use enter to enter into a nested navigation.</li>
                <li>Use escape to exit out of a nested navigation.</li>
                <li>Use enter, space, or return keys or click to activate an element.</li>
            </ul>
            <div class="grid" ${nav()}>
                <div ${nav(0, 0)}>a</div>
                <div ${nav(0, 1)}>b</div>
            ...
            <ol>
                ...
                <li>
                    ...
                    (
                    <code>:active</code>
                    cannot be triggered on non-natively-interactive elements but button elements
                    can't be nested).
                </li>
                <li>
